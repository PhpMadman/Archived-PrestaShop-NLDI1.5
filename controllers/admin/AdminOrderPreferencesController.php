			...
			'general' => array(
				...
				'fields' =>	array(
					...
					'PS_WAREHOUSE_SINGLE_COST' => array(
						...
						'desc' => $this->l('When orders from multiple warehouses, shipping cost will only be added to one order.'),
						'validation' => 'isBool',
						'cast' => 'intval',
						'type' => 'bool'
					),
					'PS_COST_WAREHOUSE_ID' => array(
						...
						'desc' => $this->l('If order contains products from this warehouse, apply cost on itt, else apply on first available warehouse'),
						'type' => 'select',
						'list' => $warehouse_list,
