...
<!--		<p class="checkbox" >
	...
	<fieldset class="account_creation">
		...
		<p class="text required">
			...
			<input onkeyup="$('#company').val(this.value);" type="text" class="text" id="companyb2b" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
		</p>
		<p class="text required">
...
<!--		<p class="text">
		...
		<p class="text required">
			<label for="website">{l s='Website'} <sup>*</sup></label>
	...
	<fieldset class="account_creation">
		...
		{/if}
		<p class="text">
			<label for="phone">{l s='Home phone'} {if $one_phone_at_least}<sup>*</sup>{/if}</label>
			<input type="text" class="text" name="phone" id="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}" />
		</p>
		<p class="text">
