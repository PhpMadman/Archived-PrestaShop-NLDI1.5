	...
	<div class="container-command">
		...
		<div style="width: 49%; float:left;">
			...
			<fieldset>
				...
				<span style="font-weight: bold; font-size: 16px;color:#3085FD"><a href="?tab=AdminCustomers&id_customer={$customer->id}&viewcustomer&token={getAdminToken tab='AdminCustomers'}">Företag: {$customer->company}</a></span><br>
				...
				<span style="font-size: 12px;color:#000000"> {$customer->siret}</span><br />
				<br />
				{if ($customer->isGuest())}
